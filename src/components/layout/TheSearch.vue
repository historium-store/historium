  ...
  <div :id="`search-block-${name}`" class="flex-1 flex-col px-6 items-center z-[45]">
    <div class="flex flex-1 mt-3">
      <input
        ...
        type="search"
        class="relative block w-max min-w-0 flex-auto rounded-2xl border border-solid border-neutral-300 bg-transparent bg-clip-padding px-3 py-[0.25rem] text-sm font-normal leading-[1.8] text-white outline-none transition duration-200 ease-in-out focus:z-[3] focus:border-primary focus:outline-none"
