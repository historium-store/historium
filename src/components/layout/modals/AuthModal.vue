<template>
  ...
  >
    ...
    >
      ...
      <div class="p-6 pt-0" v-if="currentModal === 'login'"><LoginView /></div>
      <div class="p-6 pt-0" v-else-if="currentModal === 'signup'"><SignUpView /></div>
      <div class="p-6 pt-0" v-else-if="currentModal === 'restore'"><RestoreView /></div>
      <div class="p-6 pt-0" v-else-if="currentModal === 'search'"><SearchModal /></div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...mapActions(useModalStore, ['getModal', 'showModal', 'hideModal', 'hideModals'])
  }
}
</script>
